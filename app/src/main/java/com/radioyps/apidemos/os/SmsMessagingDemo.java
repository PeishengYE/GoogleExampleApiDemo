...
package com.radioyps.apidemos.os;
...
public class SmsMessagingDemo extends Activity {
    ...
    public static final String SMS_RECIPIENT_EXTRA = "com.radioyps.apidemos.os.SMS_RECIPIENT";

    public static final String ACTION_SMS_SENT = "com.radioyps.apidemos.os.SMS_SENT_ACTION";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ComponentName componentName = new ComponentName("com.radioyps.apidemos",
                "com.radioyps.apidemos.os.SmsMessageReceiver");
