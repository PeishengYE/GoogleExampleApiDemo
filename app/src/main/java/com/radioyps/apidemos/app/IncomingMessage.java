...
//BEGIN_INCLUDE(intent_array)
    ...
    static Intent[] makeMessageIntentStack(Context context, CharSequence from,
        ...
        intents[0] = Intent.makeRestartActivityTask(new ComponentName(context,
                com.radioyps.apidemos.ApiDemos.class));

        // "App"
        intents[1] = new Intent(context, com.radioyps.apidemos.ApiDemos.class);
        intents[1].putExtra("com.radioyps.apidemos.Path", "App");
        // "App/Notification"
        intents[2] = new Intent(context, com.radioyps.apidemos.ApiDemos.class);
        intents[2].putExtra("com.radioyps.apidemos.Path", "App/Notification");
