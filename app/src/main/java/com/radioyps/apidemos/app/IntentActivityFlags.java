...
//BEGIN_INCLUDE(intent_array)
    private Intent[] buildIntentsToViewsLists() {
        ...
        intent.setClass(IntentActivityFlags.this, com.radioyps.apidemos.ApiDemos.class);
        intent.putExtra("com.radioyps.apidemos.Path", "Views");
        intents[1] = intent;

        intent = new Intent(Intent.ACTION_MAIN);
        intent.setClass(IntentActivityFlags.this, com.radioyps.apidemos.ApiDemos.class);
        intent.putExtra("com.radioyps.apidemos.Path", "Views/Lists");
